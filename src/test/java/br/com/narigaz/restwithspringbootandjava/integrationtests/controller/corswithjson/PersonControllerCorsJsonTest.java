package br.com.narigaz.restwithspringbootandjava.integrationtests.controller.corswithjson;
...
public class PersonControllerCorsJsonTest extends AbstractIntegrationTest {
    ...
    public void testCreateWithWrongOrigin() {
        ...
        var content = given().spec(specification)
                .contentType(TestConfigs.CONTENT_TYPE_JSON)
                .header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_NATY)
                    .body(person)
                .when()
                    .post()
                .then()
    ...
    @Test
    @Order(4)
    public void testFindiByIdWithWrongOrigin() {
        mockPerson();
